<!-- Footer Start -->
<div class="container-fluid bg-dark text-white-50 footer pt-5 px-5 mt-5 wow fadeIn" data-wow-delay="0.1s">
  <div class="container py-5">
    <div class="row g-5">
      ...
      <div class="col-lg-4 col-md-6">
        ...
        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Hanoi, Vietnam</p>
      ...
      <div class="col-lg-4 col-md-6">
        <h5 class="text-white mb-4">Đăng ký nhận thông báo</h5>
