  ...
  <div class="col-12">
    <div class="card p-4">
      <div class="card-header pb-0">
        ...
        <h6 class="mb-0 font-bold">Bước 2: Chọn ứng viên</h6>
      </div>
      <div class="card-body">
        ...
        <form method="POST" action="/company/interviews/create/select-candidate" role="form">
          @csrf
          <input type="hidden" name="candidates" id="candidates">
          <div class="d-flex justify-content-end gap-4 mt-4">
            <a href="/company/interviews/create" class="btn btn-secondary" type="button">Quay lại</a>
